...
function deleteTask() {
  ...
  function task() {
    ...
    for(var i=0, len=localStorage.length; i<len; i++) {
      ...
      if (res == true) {
        ...
        var collapseItems = collapseItems + "<div style='color: #191919; padding-top: 10px; padding-left: 20px; width: 100%; padding-right: 10px;' class='card card-body'><div id='" + namerer + "' > </div><p style='font-size: 16px;'>" + bold + "</p><br><p style='width: 100%; color: rgb(24, 24, 24)' >" + d + "</p><br><div id='" + namererer + "'></div><div id='" + namerererer + "'></div><div id='" + namererererer + "'></div><div id='" + namerererererer + "'></div><div></div></div>"
  ...
  // Add date to element
     ...
     x.innerHTML = '<button style="font-size: 16px; position: absolute; top: 10px; right: 10px; border-radius: 120px; height: 35px; width: 60px; background-color: white; color: black;" data-trigger="focus" data-container="body" data-toggle="popover" data-placement="left" data-content="' + oName + " is for " + f + "." + " That is currently about " + diff + " days away." + '" type="button" class="btn btn-primary" data-toggle="button" aria-pressed="false" autocomplete="off"><i class="material-icons">today</i></p></button>'
    // Tags
